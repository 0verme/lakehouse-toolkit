...
Phase 2 不实现 SQL/AST extraction、Physical DAG、Audit、TMP collapse、materialization、
query/viewer、incremental rebuild 或 history/diff；本页的 program-name target recovery
只属于 metadata semantic boundary，不替代 SQL parser。
